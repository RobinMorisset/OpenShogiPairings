...
export const ERROR_CODE_KEYS: Record<string, string> = {
  ...
  csv_unterminated_quote: "playerRegistration.csvErrorUnterminatedQuote",
  csv_ragged_rows: "playerRegistration.csvErrorRaggedRows",
  csv_rows_bad_rating: "playerRegistration.csvErrorRowsBadRating",
  csv_rows_bad_grade: "playerRegistration.csvErrorRowsBadGrade",
  csv_rows_ambiguous_rated_player: "playerRegistration.csvErrorRowsAmbiguousRatedPlayer",
  ...
  team_mode_rejects_cup: "serverError.teamModeRejectsCup",
  team_mode_rejects_long_games: "serverError.teamModeRejectsLongGames",
  team_mode_rejects_elo_pairing: "serverError.teamModeRejectsEloPairing",
  team_mode_rejects_grade_thresholds: "serverError.teamModeRejectsGradeThresholds",
  team_mode_rejects_est_elo_tiebreak: "serverError.teamModeRejectsEstEloTiebreak",
  invalid_team_size: "serverError.invalidTeamSize",
  team_settings_locked: "serverError.teamSettingsLocked",
  empty_team_name: "serverError.emptyTeamName",
  duplicate_team_name: "serverError.duplicateTeamName",
  team_is_full: "serverError.teamIsFull",
  players_without_team: "serverError.playersWithoutTeam",
  incomplete_team: "serverError.incompleteTeam",
  members_without_pairing_rating: "serverError.membersWithoutPairingRating",
  pairing_ratings_would_be_discarded: "serverError.pairingRatingsWouldBeDiscarded",
